                    ...
                    <form action="{{route('interview_peoples.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tab-content" id="custom-tabs-three-tabContent">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-ru" role="tabpanel">
                                <div class="form-group">
                                    <label>Ф.И.О</label>
                                    <input type="text" class="form-control @error('full_name_ru') border-danger @enderror" name="full_name_ru" value="{{old('full_name_ru')}}">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-three-en" role="tabpanel">
                                <div class="form-group">
                                    <label>Ф.И.О</label>
                                    <input type="text" class="form-control @error('full_name_en') border-danger @enderror" name="full_name_en" value="{{old('full_name_en')}}">
                                    <small class="text-danger">{{$errors->first('full_name_en')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="description_en">Краткая информация</label>
